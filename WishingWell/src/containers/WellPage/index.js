    ...
    return (
      <View>
        ...
        <View>
          <Button
            title="Donate $1"
            onPress={()=> navigate('StripePage', {well_id: well.id, amount: 100})}
            color='#84DBEF'
            />
          <Button
            title="Donate $5"
            onPress={()=> navigate('StripePage', {well_id: well.id, amount: 500})}
            color='#84DBEF'
            />
          ...
          <Button
            ...
            onPress={()=> navigate('StripePage', {well_id: well.id, amount: this.state.custom_donation * 100})}
            color='#84DBEF'
            />
